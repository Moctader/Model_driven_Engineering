...
if __name__ == "__main__":
    ...
    model = MLModel(model_type='LinearRegression', features=['feature1', 'feature2'], target='target')
    ...
    # Uncomment the next line to execute the training script (make sure 'data.csv' exists)
